...
export class AddSocialAccountsAndNullablePassword1773823617791 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      await queryRunner.query(
        `CREATE INDEX "IDX_7de933c3670ec71c68aca0afd5" ON "social_accounts" ("userId") `,
      );
      ...
      await queryRunner.query(
        `ALTER TABLE "auth_refresh_tokens" ADD CONSTRAINT "FK_4cee0cefed5da7cdacff696683c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
      );
      await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "auth_refresh_tokens" DROP CONSTRAINT "FK_4cee0cefed5da7cdacff696683c"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "auth_refresh_tokens" ADD CONSTRAINT "FK_auth_refresh_tokens_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}

...
import { CONSENT_SCOPES, CONSENT_SOURCES } from '../domain/userConsent.entity';

import type { ConsentScope, ConsentSource, UserConsent } from '../domain/userConsent.entity';
import type { IUserConsentRepository } from '../domain/userConsent.repository.interface';

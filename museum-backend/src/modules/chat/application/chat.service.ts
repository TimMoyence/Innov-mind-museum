...
export class ChatService {
  ...
  async getSession(
    ...
    return this.sessions.getSession(sessionId, page, currentUserId);
  }
  ...
  async listSessions(
    ...
    return this.sessions.listSessions(page, currentUserId);
  }
  ...
  async deleteSessionIfEmpty(
    ...
    return this.sessions.deleteSessionIfEmpty(sessionId, currentUserId);
  }
  ...
  async postMessage(
    ...
    return this.messages.postMessage(sessionId, input, requestId, currentUserId);
  }
  ...
  async postMessageStream(
    ...
    return this.messages.postMessageStream(sessionId, input, onToken, onGuardrail, requestId, currentUserId, signal);
  }
  ...
  async postAudioMessage(
    ...
    return this.messages.postAudioMessage(sessionId, input, requestId, currentUserId);
  }
  ...
  async getMessageImageRef(
    ...
    return this.media.getMessageImageRef(messageId, currentUserId);
  }
  ...
  async reportMessage(
    ...
    return this.media.reportMessage(messageId, reason, currentUserId, comment);
  }
  ...
  async synthesizeSpeech(
    ...
    return this.media.synthesizeSpeech(messageId, currentUserId);
  }
}

...
export const makeChatRepo = (
  ...
  findAudioRefsByUserId: jest.fn().mockResolvedValue([]),
  listMessageFeedbackForUser: jest.fn().mockResolvedValue([]),
  listMessageReportsForUser: jest.fn().mockResolvedValue([]),

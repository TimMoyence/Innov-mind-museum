...
const mockAdminDict: Dictionary['admin'] = {
  ...
  analyticsPage: {
    subtitle: '', avgMessages: '', avgDuration: '', returnRate: '',
    uniqueUsers: '', returningUsers: '', usage: '', daily: '', weekly: '',
    monthly: '', days: '', sessions: '', messagesSent: '', activeUsers: '',
    topArtworks: '', topMuseums: '', museum: '', guardrailBlockRate: '',
  },
};

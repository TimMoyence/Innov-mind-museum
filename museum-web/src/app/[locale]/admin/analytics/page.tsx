export default function AnalyticsPage() {
  return (
    <div>
      ...
      <p className="mt-1 text-text-secondary">Platform usage analytics and charts.</p>

      <div className="mt-8 rounded-xl border border-primary-100 bg-white p-12 text-center text-text-muted">
        Analytics charts will be displayed here once the API integration is complete.
      </div>
    </div>
  );
}

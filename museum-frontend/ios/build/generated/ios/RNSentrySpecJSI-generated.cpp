...
static jsi::Value __hostFunction_NativeRNSentryCxxSpecJSI_setAttribute(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeRNSentryCxxSpecJSI *>(&turboModule)->setAttribute(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asString(rt)
  );
...
static jsi::Value __hostFunction_NativeRNSentryCxxSpecJSI_setAttributes(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeRNSentryCxxSpecJSI *>(&turboModule)->setAttributes(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asObject(rt)
  );
  return jsi::Value::undefined();
...
static jsi::Value __hostFunction_NativeRNSentryCxxSpecJSI_enableShakeDetection(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeRNSentryCxxSpecJSI *>(&turboModule)->enableShakeDetection(
    rt
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeRNSentryCxxSpecJSI_disableShakeDetection(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeRNSentryCxxSpecJSI *>(&turboModule)->disableShakeDetection(
    rt
  );
  return jsi::Value::undefined();
}
...
NativeRNSentryCxxSpecJSI::NativeRNSentryCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["setAttribute"] = MethodMetadata {2, __hostFunction_NativeRNSentryCxxSpecJSI_setAttribute};
  methodMap_["setAttributes"] = MethodMetadata {1, __hostFunction_NativeRNSentryCxxSpecJSI_setAttributes};
  ...
  methodMap_["enableShakeDetection"] = MethodMetadata {0, __hostFunction_NativeRNSentryCxxSpecJSI_enableShakeDetection};
  methodMap_["disableShakeDetection"] = MethodMetadata {0, __hostFunction_NativeRNSentryCxxSpecJSI_disableShakeDetection};
}

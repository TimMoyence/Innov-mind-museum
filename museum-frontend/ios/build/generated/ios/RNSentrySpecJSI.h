...
public:
  ...
  virtual void setAttribute(jsi::Runtime &rt, jsi::String key, jsi::String value) = 0;
  virtual void setAttributes(jsi::Runtime &rt, jsi::Object attributes) = 0;
  ...
  virtual void enableShakeDetection(jsi::Runtime &rt) = 0;
  virtual void disableShakeDetection(jsi::Runtime &rt) = 0;
...
private:
  ...
  public:
    ...
    void setAttribute(jsi::Runtime &rt, jsi::String key, jsi::String value) override {
      static_assert(
    ...
    void setAttributes(jsi::Runtime &rt, jsi::Object attributes) override {
      static_assert(

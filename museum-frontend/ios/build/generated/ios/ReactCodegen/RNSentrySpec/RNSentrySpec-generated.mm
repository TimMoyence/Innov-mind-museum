...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeRNSentrySpecJSI_enableShakeDetection(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "enableShakeDetection", @selector(enableShakeDetection), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeRNSentrySpecJSI_disableShakeDetection(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "disableShakeDetection", @selector(disableShakeDetection), args, count);
    }
  ...
  NativeRNSentrySpecJSI::NativeRNSentrySpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["enableShakeDetection"] = MethodMetadata {0, __hostFunction_NativeRNSentrySpecJSI_enableShakeDetection};
        
        
        methodMap_["disableShakeDetection"] = MethodMetadata {0, __hostFunction_NativeRNSentrySpecJSI_disableShakeDetection};

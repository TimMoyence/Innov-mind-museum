...
protected:
  NativeRNSentryCxxSpec(std::shared_ptr<CallInvoker> jsInvoker) : TurboModule(std::string{NativeRNSentryCxxSpec::kModuleName}, jsInvoker) {
    ...
    methodMap_["enableShakeDetection"] = MethodMetadata {.argCount = 0, .invoker = __enableShakeDetection};
    methodMap_["disableShakeDetection"] = MethodMetadata {.argCount = 0, .invoker = __disableShakeDetection};
  }
...
private:
  ...
  static jsi::Value __enableShakeDetection(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::enableShakeDetection) == 1,
      "Expected enableShakeDetection(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::enableShakeDetection,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }

  static jsi::Value __disableShakeDetection(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    static_assert(
      bridging::getParameterCount(&T::disableShakeDetection) == 1,
      "Expected disableShakeDetection(...) to have 1 parameters");
    bridging::callFromJs<void>(rt, &T::disableShakeDetection,  static_cast<NativeRNSentryCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));return jsi::Value::undefined();
  }
};

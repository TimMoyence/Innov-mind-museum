...
with_node \
  ...
  --target "/Users/Tim/Desktop/all/dev/Pro/InnovMind/.claude/worktrees/auth-mfa-rgpd-zerodefect/museum-frontend/ios/Pods/Target Support Files/Pods-Musaium/ExpoModulesProvider.swift" \
  --entitlement "/Users/Tim/Desktop/all/dev/Pro/InnovMind/.claude/worktrees/auth-mfa-rgpd-zerodefect/museum-frontend/ios/Musaium/Musaium.entitlements" \
   \
  --platform "apple" \

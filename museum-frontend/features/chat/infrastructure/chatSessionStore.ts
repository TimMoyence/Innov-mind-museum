...
interface ChatSessionState {
  ...
  setSession: (sessionId: string, messages: ChatUiMessage[], title: string | null, museumName: string | null) => void;
 ...
 */
const evictOldSessions = (sessions: Record<string, PersistedSession>): Record<string, PersistedSession> => {

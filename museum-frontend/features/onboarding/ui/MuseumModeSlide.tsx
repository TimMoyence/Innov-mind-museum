...
/** Slide 2 of onboarding v2 Spec B: museum mode — geo-aware context. */
export const MuseumModeSlide = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.title, { color: theme.textPrimary }]} accessibilityRole="header">
        {t('onboarding.v2.museumMode.title')}
      </Text>
      <Text style={[styles.description, { color: theme.textSecondary }]}>
        {t('onboarding.v2.museumMode.description')}
      </Text>
    </Animated.View>
  );
};

...
/** Slide 3 of onboarding v2 Spec B: camera intent — photograph artworks. */
export const CameraIntentSlide = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.title, { color: theme.textPrimary }]} accessibilityRole="header">
        {t('onboarding.v2.cameraIntent.title')}
      </Text>
      <Text style={[styles.description, { color: theme.textSecondary }]}>
        {t('onboarding.v2.cameraIntent.description')}
      </Text>
    </Animated.View>
  );
};

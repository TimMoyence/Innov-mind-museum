# ADR-034 — Defer zod 3→4 migration to post-launch

> Renumbered from ADR-031 on 2026-05-07 to resolve collision with `ADR-031-mobile-cert-pinning-kill-switch.md`. Original commit `4efb60db4` references the old number.

Status: Accepted (2026-05-05, renumbered 2026-05-07)

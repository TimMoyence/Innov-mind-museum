...
| P1-7 | ✅ ADR-050 accepts langfuse v3 EOL until 2026-09-01; tilde-pinned | `96526b03` | Audit said cost-tracking concern — N/A for Musaium (verified: tracing-only, no cost capture in code). |

...
| **P0-6** | `museum-web/src/lib/admin-types.ts:UserRole` ne contient pas `super_admin` alors que `auth.tsx` l'utilise — **bug RBAC silencieux** | 03 | 30 min | Mauvaise vérification rôle admin Web |

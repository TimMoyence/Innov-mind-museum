...
| **Durée de conservation** | Compte : jusqu'à suppression utilisateur (Art. 17). Refresh tokens : **14 jours absolus** (durcissement F8 2026-04-30 ; antérieurement 30j) + sliding 24 h. Token de reset mot de passe : **1 heure** (`forgotPassword.useCase.ts:52`). Audit logs : 13 mois (hot + cold) — IP anonymisée à l'expiration. **Rationale Art. 5(1)(e) (minimisation, controller decision 2026-05-13)** : 13 mois cale la rétention sur (i) lignes directrices CNIL anti-fraude (12 mois floor) + (ii) délai-type de contestation Art. 22 RGPD + (iii) cycle annuel d'audit. À ratifier par DPO ; révision si la jurisprudence resserre. |

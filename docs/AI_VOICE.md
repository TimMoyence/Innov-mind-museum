...
| `useTextToSpeech` | `museum-frontend/features/chat/application/useTextToSpeech.ts` | Fetch + playback TTS. Cache `expo-file-system` implémenté (import ligne 4, `cacheDirectory` ligne 53). |
